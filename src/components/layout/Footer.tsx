        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 border border-white/20 rounded flex items-center justify-center hover:bg-white/10" aria-label="Instagram">
              ...
              <a href="#" className="w-8 h-8 border border-white/20 rounded flex items-center justify-center hover:bg-white/10" aria-label="Facebook">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Elbise', 'Takım', 'Alt Giyim', 'Üst Giyim', 'Dış Giyim', 'Abiye', 'Şal & Kemer'].map(cat => (
                <li key={cat}>
                  <Link
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-white/60 text-sm">+90 (212) 000 00 00</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-white/40 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-white/60 text-sm">info@ebruca.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-white/40 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
                <a href="https://wa.me/905000000000" className="text-white/60 text-sm hover:text-white">WhatsApp Destek</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              {['VISA', 'MC', 'TR', '3D'].map(card => (
                <span key={card} className="px-2 py-0.5 border border-white/20 rounded text-white/50 text-xs">
                  {card}
                </span>
              ))}
            </div>
