...
export default async function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initial = {
    ...
    colorSizes: JSON.parse(product.colorSizes || '{}') as Record<string, string[]>,
    colorSizeStock: JSON.parse(product.colorSizeStock || '{}') as Record<string, Record<string, number>>,
    isNew: product.isNew,
